...
public class Program
{
    private static void Main(string[] args)
    {
        ...
        */
        Node<Ranges> rangeList = new Node<Ranges>(new Ranges(10, 5), new Node<Ranges>(new Ranges(-2, -5), new Node<Ranges>(new Ranges(100, 85), new Node<Ranges>(new Ranges(30, 20)))));
